...
1. Download `sales_analysis.xlsm` from this repo
2. Enable macros when prompted
3. Use the **Year slicer** on the dashboard to filter all views
4. Explore individual sheets: `Analysis 1`, `Analysis 2`, `Time Series Dashboard`
5. The Data Model and all DAX measures are accessible via **Power Pivot → Manage**
...
🔗 [linkedin.com/in/jennisha-k-66a195191](https://linkedin.com/in/jennisha-k-66a195191)
